...
function install_node {
    #get the latest version of nodejs from ppa
...
function install_sublime {
    #downloading sublime
    wget http://c758482.r82.cf2.rackcdn.com/sublime-text_build-3083_amd64.deb -o sublime-text_build-3083_amd64.deb
    ...
    chmod 755 sublime-text_build-3083_amd64.deb
    dpkg -i sublime-text_build-3083_amd64.deb
    #add package control on sublime
    cp "Package Control.sublime-package" ~/.config/sublime-text-3/Installed Packages/
    #fetch settings sublime
    git clone https://github.com/fallen90/sublime-settings.git
    cp ./sublime-settings/"Package Control.sublime-settings" ~/.config/sublime-text-3/Packages/User/"Package Control.sublime-settings"
}
